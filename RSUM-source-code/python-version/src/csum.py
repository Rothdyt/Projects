...
class CSUM:
    def __init__(self, x, y, Lambda, logname="csum.log"):
        self.x = x
        self.y = y
        self.Lambda = Lambda
        ...
        self.log = logger
        self.log.info("csum-- N:{} | d:{} | lambda:{}".format(self.n, self.d, self.Lambda))
    ...
    def solve(self, accuracy=1e-6, criteria='fseq', checkpoint=False, checkpoint_path='./csum.pkl', fmin=None):
        if checkpoint:
...
if __name__ == '__main__':
    ...
    solver = CSUM(x=X, y=y, Lambda=0.01)
